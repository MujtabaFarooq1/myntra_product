...
// Import Utils
import { getCartTotal } from "../../../utils/index";
...
function CartMenu(props) {
  ...
  function removeFromCart(e, cart) {
    ...
    props.removeFromCart({ product: cart });
  }
          ...
          {cartItems.length > 0 ? (
            <>
              ...
              <div className="dropdown-cart-action">
                <ALink href="cart" className="btn btn-gray btn-block view-cart">
                  View Cart
                </ALink>
                <ALink
                  href="/checkout"
...
function mapStateToProps(state) {
  return {
    cartItems: state.cart.cart ? state.cart.cart : [],
  };
}

export default connect(mapStateToProps, cartActions)(CartMenu);
