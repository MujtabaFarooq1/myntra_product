            ...
            blog.picture.length > 1 ? (
              ...
              >
                {blog.picture.map((picture, index) => (
                  <LazyLoadImage
                    alt="post_image"
                    src={process.env.REACT_APP_LOCAL_ASSET_URL + picture.url}
                    threshold={500}
                    width="100%"
                    height="100%"
                    effect="blur"
              ...
              <LazyLoadImage
                alt="post_image"
                src={
                  process.env.REACT_APP_LOCAL_ASSET_URL + blog.picture[0].url
                }
                threshold={500}
                width="100%"
                height="100%"
...
export default connect(null, { ...modalActions })(BlogSingle);
