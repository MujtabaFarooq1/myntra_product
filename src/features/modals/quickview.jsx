...
function QuickModal(props) {
  ...
  // console.log("I got props is ->", props);
...
// console.log("Modal Actions are ->", modalActions);

// export default QuickModal;

export default connect(mapStateToProps, { ...modalActions })(QuickModal);
