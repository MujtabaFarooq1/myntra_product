...
function WishlistPage(props) {
  ...
  const onQuickViewClick = (e, product) => {
    e.preventDefault();
    showQuickView({ slug: product.slug });
  };

  return (
    <main className="main" href="#">
                  ...
                  <tr key={"wishlist-item" + index} className="product-row">
                    ...
                    <td>
                      <h5 className="product-title">
                        <ALink href={`/products/${item.id}`}>{item.name}</ALink>
                      </h5>
                    </td>
                    <td>
                      <div className="price-box">
                        ...
                        item.price[0] === item.price[1] ? (
                          ...
                          <span className="product-price">
                            {"$" + item.variants[0].price.toFixed(2)} &ndash;{" "}
                          </span>
                        ) : (
                          <>
